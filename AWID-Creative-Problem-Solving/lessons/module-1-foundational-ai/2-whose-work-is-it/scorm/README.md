# SCORM 1.2 package — "Whose Work Is It?"

SCORM 1.2 package source for Module 1's ownership/responsible-use lesson. Runs two ways:
...
```bash
cd scorm
zip -r ../whose-work-is-it-scorm12.zip imsmanifest.xml index.html styles.css scorm-api.js
```
