# SCORM 1.2 package — "Your Data Isn't Private"

SCORM 1.2 package source for Module 1's privacy/data-governance lesson. Runs two ways:
...
```bash
cd scorm
zip -r ../your-data-isnt-private-scorm12.zip imsmanifest.xml index.html styles.css scorm-api.js
```
