# SCORM 1.2 package — "Who Wins With AI?"

SCORM 1.2 package source for Module 1's AI-as-a-tool lesson. Runs two ways:
...
```bash
cd scorm
zip -r ../who-wins-with-ai-scorm12.zip imsmanifest.xml index.html styles.css scorm-api.js
```
