# SCORM 1.2 package — "Build Systems, Not Outputs"

SCORM 1.2 package source for Module 3's core-thesis lesson. Runs two ways:
...
```bash
cd scorm
zip -r ../build-systems-not-outputs-scorm12.zip imsmanifest.xml index.html styles.css scorm-api.js
```
