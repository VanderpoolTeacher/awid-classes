# SCORM 1.2 package — "The Production Pipeline"

SCORM 1.2 package source for Module 3's capstone lesson. Runs two ways:
...
```bash
cd scorm
zip -r ../the-production-pipeline-scorm12.zip imsmanifest.xml index.html styles.css scorm-api.js
```
